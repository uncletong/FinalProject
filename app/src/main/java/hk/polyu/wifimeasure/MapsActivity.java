...
import hk.polyu.dc.wifimeasure.R;
import hk.polyu.dc.wifimeasure.Wifi;
...
//                .add(new LatLng(22.302470, 114.187107), new LatLng(22.300675, 114.187290), new LatLng(22.301852, 114.190798))
...
//                .strokeColor(0xAAFFFF00));
    ...
    protected void startLocationUpdates() {
        ...
        GetMessage getMessage1 = new GetMessage(this,1);
        GetMessage getMessage2 = new GetMessage(this,2);
        GetMessage getMessage3 = new GetMessage(this,3);
        GetMessage getMessage4 = new GetMessage(this,4);
        new Thread(getMessage1).start();
        new Thread(getMessage2).start();
        new Thread(getMessage3).start();
        new Thread(getMessage4).start();
    }
...
//    }
    ...
    public void circleAdd1(final Double latitude, final Double longitude){
    ...
    public void circleAdd2(final Double latitude, final Double longitude){
        runOnUiThread(new Runnable() {
            private Double lat = latitude;
            private Double lon = longitude;
            @Override
            public void run() {
                ...
                mMap.addCircle(new CircleOptions()
                        .center(new LatLng(latitude,longitude))
                        .radius(10)
                        .fillColor(0xAAFC2F03)
                        .strokeColor(0xAAFC2F03));
            }
        });
    }
    public void circleAdd3(final Double latitude, final Double longitude){
        runOnUiThread(new Runnable() {
            private Double lat = latitude;
            private Double lon = longitude;
            @Override
            public void run() {
                ...
                mMap.addCircle(new CircleOptions()
                        .center(new LatLng(latitude,longitude))
                        .radius(10)
                        .fillColor(0xAA038FFC)
                        .strokeColor(0xAA038FFC));
            }
        });
    }
    public void circleAdd4(final Double latitude, final Double longitude){
        runOnUiThread(new Runnable() {
            private Double lat = latitude;
            private Double lon = longitude;
            @Override
            public void run() {
                ...
                mMap.addCircle(new CircleOptions()
                        .center(new LatLng(latitude,longitude))
                        .radius(10)
                        .fillColor(0xAAF30AA2)
                        .strokeColor(0xAAF30AA2));
            }
        });
    }
    protected void createLocationRequest() {
